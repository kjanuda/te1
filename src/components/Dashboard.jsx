    ...
    <div className="w-full min-h-screen bg-gray-100">
      ...
      <div className="flex w-full h-[calc(100vh-64px)]">
        ...
        <motion.div
          ...
          className="w-64 bg-blue-800 text-white p-6 flex-shrink-0"
        >
          <div className="flex items-center space-x-2 mb-8">
            <div className="w-12 h-12 bg-blue-600 rounded-full p-4 flex items-center justify-center">
        ...
        <div className="flex-1 w-full overflow-auto">
          ...
          <motion.div
            ...
            transition={{ duration: 0.5 }}
            className="bg-white p-4 shadow flex justify-between items-center w-full"
          >
          ...
          {activeTab === 'overview' && (
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6 w-full">
                {/* Card 1 */}
                <motion.div whileHover={{ y: -5 }} className="bg-white rounded-lg shadow p-6 w-full">
                ...
                <motion.div whileHover={{ y: -5 }} className="bg-white rounded-lg shadow p-6 w-full">
                  ...
                  <p className="text-green-500 text-sm">
                    {Math.round((attendanceSummary.present / attendanceSummary.total) * 100)}% attendance rate
                  </p>
                </motion.div>
              ...
              >
                ...
                <div className="flex flex-wrap gap-4">
                  ...
                  <div className="bg-yellow-50 rounded-lg p-4 flex-1 min-w-[200px]">
                    <div className="flex items-center justify-between">
          ...
          {activeTab !== 'overview' && (
            <motion.div
              ...
              animate={{ opacity: 1 }}
              transition={{ duration: 0.5 }}
              className="p-6 flex items-center justify-center h-full w-full"
            >
